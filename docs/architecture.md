...
/path/to/worktrees/<repo>/feature/auth

# Shell function performs:
cd /path/to/worktrees/<repo>/feature/auth
```
...
Branch names with slashes become directory structure (e.g., `feature/auth` → `../worktrees/<repo>/feature/auth/`)
